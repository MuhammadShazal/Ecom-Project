        ...
        <div className="overflow-hidden">
            {userData ?
                ...
                <div className="flex gap-2">
                    <Link href="/signup" className="md:flex text-white bg-gray-900 px-3 py-1 md:mr-0">SignUp</Link>
                    <Link href="/signin" className=" text-white border border-black-800 px-3 py-1 mr-10 md:mr-0">SignIn</Link>
                </div>
            }
