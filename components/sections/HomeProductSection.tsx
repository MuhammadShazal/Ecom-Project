...
const HomeProductSection: FC<{ ProductData: Array<oneProductType> }> = ({ ProductData }) => {
    let initialX: number;
    ...
    return (
        ...
        <div className="space-y-4">
            ...
            <div
                ...
                onMouseUp={mouseUp}
                className="flex gap-4 overflow-x-hidden scrollGrab py-4 overflow-y-hidden select-none "
